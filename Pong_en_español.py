# "Pong en español" // Código estudiado y traducido por Ivan Robayo @jhonnyvector - Colombia 8/04/2022.
# Tutorial tomado de freecodecamp.org (Christian Thompson.)

import turtle

wn = turtle.Screen()
wn.title = ("EJERCICIO: Pong en español. Escrito en Python. Código fuente en GitHub @jhonnyvector")
wn.bgcolor("black")
